...
Using Github with Git allows you to easily make a cloud backup of your important code, so that even if your  computer suddenly catches on fire, all of your important code files exist somewhere else. 
...
![git pull copies the version of the project on GitHub to your computer](image/git_pull_diagram.png)
![git push copies the version of the project on your computer to GitHub](image/git_push_diagram.png)
