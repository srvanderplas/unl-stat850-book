...
```{r sas-college-read-data-setup, include = F, collectcode=T, fig.path = "image/", engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, error = T}
ODS HTML style=HTMLBLUE;
```
```{r sas-college-read-data, fig.path = "image/", engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, collectcode = F, error = T}
...
```{r sas-college-find, fig.path = "image/", engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, collectcode = F, error = T}
libname classdat "sas/";
...
```{r sas-college-split-string-words-setup, collectcode=T, include = F, fig.path = "image/", engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, error = T}
ODS HTML style=HTMLblue;
```
```{r sas-college-split-string-words, fig.path = "image/", engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, collectcode = F, error = T}
libname classdat "sas/";
DATA collegename;
SET classdat.college;
...
```{r regex-sas, fig.path = "image/", engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, collectcode = F, error = T}
DATA strings;
...
```{r regex-sas-2, fig.path = "image/", engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, collectcode = F, error = T}
DATA strings;
  INFILE DATALINES DSD; /* This allows quoted strings */
  INPUT string ~ $150.; /* ~ says deal with quoted strings */
  DATALINES;
...
```{r five-ducks-example-sas, fig.path = "image/", engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, collectcode = F, error = T}
DATA ducks;
...
```{r squirrelcensus-data, include = F, eval = F}
...
```{r sas-squirrelcensus-data-read-in, fig.path = "image/", engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, collectcode = F, error = T}
libname classdat "sas/";
...
<details><summary>SAS solution</summary>
```{r sas-squirrel-colorfix, fig.path = "image/", engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, collectcode = F, error = T}
libname classdat "sas/";
...
```{r sas-table3-scan, fig.path = "image/", engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, collectcode = F, error = T}
data table3;
...
```{r sas-table5-concatenate, fig.path = "image/", engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, collectcode = F, error = T}
/* read in the data */
DATA table5;
...
```{r sas-proc-transpose, fig.path = "image/", engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, collectcode = F, error = T}
DATA table4a;
...
```{r sas-proc-transpose-2, fig.path = "image/", engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, collectcode = F, error = T}
DATA table4a;
input country $12. _1999 _2000;
id = "cases";
datalines;
...
```{r sas-proc-transpose-stack, fig.path = "image/", engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, collectcode = F, error = T}
DATA table4a;
input country $12. _1999 _2000;
id = "cases";
datalines;
...
```{r sqlite3-nycflights-sas, echo = F, fig.path = "image/", engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, collectcode = F, error = T}
...
```{r sql-sas-mutating-joins, fig.path = "image/", engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, collectcode = F, error = T}
data t1;
input x $ y;
datalines;
A 1
...
```{r sas-data-mutating-joins, fig.path = "image/", engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, collectcode = F, error = T}
data t1;
input x $ y;
datalines;
A 1
...
```{r flights-delay-age-sas-prep, collectcode=T, fig.path = "image/", engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, error = T}
libname nycair odbc complete = "dsn=nycflight; Database=data/nycflights13.sqlite";
...
```{sashtml flights-delay-age-sas-res, collectcode=T, fig.path = "image/", engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, error = T}
...
```{sashtml flights-delay-age-sas-plot1-setup, include = F, collectcode=T, fig.path = "image/", engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, error = T}
ODS HTML style=HTMLBLUE;
```
```{sashtml flights-delay-age-sas-plot1, collectcode=T, fig.path = "image/",  engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, error = T}
...
```{sashtml flights-delay-age-sas-plot2-setup, include = F, collectcode=T, fig.path = "image/",  engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, error = T}
ODS HTML style=HTMLBLUE;
```
```{sashtml flights-delay-age-sas-plot2, collectcode=T, fig.path = "image/",  engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, error = T}
...
```{r tidy-gas-data-longer-view}
head(gas_prices_long)
```

Now we're ready to move back into wide-er form
```{r tidy-gas-data-wide}
# 
...
```{r read-data-sas, collectcode=T, fig.path = "image/",  engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, error = T}
/*********************************************************/
...
```{r split-data-sas-properly, collectcode=T, fig.path = "image/",  engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, error = T}
...
```{r transpose-data-sas, collectcode=T, fig.path = "image/",  engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, error = T}
...
```{r transpose-data-sas2, collectcode=T, fig.path = "image/",  engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, error = T}
...
```{r merge-data-sas, collectcode=T, fig.path = "image/",  engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, error = T}
...
```{r format-dates-sas, collectcode=T, fig.path = "image/",  engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, error = T}
...
```{r plot-data-sas, collectcode=T, fig.path = "image/",  engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, error = T}
