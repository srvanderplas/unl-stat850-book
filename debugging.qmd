...
- Collect your often-reused code in packages that you can easily load and make available to "future you"
...
```{r traceback-rerun-debug-pic, echo = F, fig.cap = "Both Show Traceback and Rerun with Debug are useful tools", out.width = "50%"}
