...
```{sas sas-make-new-vars, fig.path = "image/"}
libname classdat "sas/";
...
```{sashtml sas-make-new-vars-sql, fig.path = "image/"}
libname classdat "sas/";
...
```{sashtml sas-group-by-storms-1, fig.path = "image/"}
libname classdat "sas/";
...
```{sashtml storms-duration-category-sas, fig.path = "image/"}
libname classdat "sas/";
PROC SQL;
...
```{sashtml storm-evolution-sas, fig.path = "image/"}
libname classdat "sas/";
PROC SQL;
...
```{sashtml ike-evolution-sas-demo, collectcode=T, include = F}
ODS HTML style= HTMLBlue; /* needed for color graphs in bookdown */
```
```{sashtml ike-evolution-sas, collectcode=T, fig.path = "image/"}
libname classdat "sas/";
...
XXX TODO: add more about across XXX
...
filename fileloc '~/Projects/Class/unl-stat850/2020-stat850/data/gapminder.csv';
