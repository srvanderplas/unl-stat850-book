...
In SAS, though, there's a proc that is going to be more useful for this type of work: PROC SQL. `dplyr` is built off of SQL philosophy and is designed to let you take advantage of the power of R for doing computations (because SQL's statistical abilities are limited). Similarly, PROC SQL in SAS is going to allow you to do powerful things and then take advantage of SAS's statistical powers.
...
One layer of grouping? What does that mean, you may ask yourself. 

<details><summary>Allow me to demonstrate.</summary>
...
<details><summary>One thing we might want to know is at what point each storm was the strongest. (group_by + filter + summarize)</summary> Let's define strongest in the following way: 
