...
df <- python$df
```
One very easy way to do this task is to use a specialized `parse_number` function. In Python, this exists in the `babel` package, in R, it is part of the `readr` package.
