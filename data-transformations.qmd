...
One of the most common tasks when reading in and tidying messy data is that numeric-ish data can come in many forms that are read (by default) as strings.

```{python, echo = F, results = 'asis'}
#| label: tbl-parse-numbers
#| tbl-cap: Different number formats
