...
![Primary School Database Schema](images/data-transformations/PrimarySchoolExample.png)
...
![The nycflights database schema](https://d33wubrfki0l68.cloudfront.net/245292d1ea724f6c3fd8a92063dcd7bfb9758d02/5751b/diagrams/relational-nycflights.png)
[here](https://r4ds.had.co.nz/relational-data.html#nycflights13-relational) (scroll down a bit).
...
The US Energy Information Administration tracks gasoline prices, with data available on a weekly level since late 1994. You can go to [this site](https://www.eia.gov/dnav/pet/hist/LeafHandler.ashx?n=pet&s=emm_epm0u_pte_nus_dpg&f=w) to see a nice graph of gas prices, along with a corresponding table.
<!-- (or you can look at the screenshot below, as I don't really trust that the site design will stay the same...) -->
...
<iframe width="736" height="414" src="https://www.youtube.com/embed/n70eAKJmzRo" title="06 Tidying Gas Price Data (in Excel)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
![](images/data-transformations/gas-prices-steps2.png)
#### R solution
