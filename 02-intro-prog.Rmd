...
## Intro to Programming: Module Objectives  {-}
...
<details class="example"><summary>Factors example</summary>
...
<details><summary>We could get this same behavior without the data.frame, but this is where it shows up most often</summary>
