...
::: {.callout-note callout-collapse=true}
### dplyr::relocate
...
![dplyr's across() function lets you apply a mutate or summarize statement to many columns (by Allison Horst)](https://github.com/allisonhorst/stats-illustrations/raw/main/rstats-artwork/dplyr_across.png)
