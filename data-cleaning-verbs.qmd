...
```{python storm-evo-py}
storm_evolution = storms.loc[storms.hurricane_force_diameter.notnull(),:].groupby(["name", "year"]).agg(time_since_start = ("time", lambda x: x - x.min())).reindex()
