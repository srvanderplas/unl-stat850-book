...
#### While Loops: Try it Out! {.unnumbered .tryitout}
...
#### Example: For Loops {.ex .unnumbered}
...
#### Example: Next/Continue statements {.ex .unnumbered}
...
There is some extensive material on this subject in [R for Data Science on functions](https://r4ds.had.co.nz/functions.html) [@r4ds]. If you want to really understand how functions work in R, that is a good place to go.
