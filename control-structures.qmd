...
![Venn Diagram of Set A and Set B](images/control-structures/SetA%20and%20SetB.png){width="50%"}

Suppose that we set the convention that 

![Shaded regions are TRUE, unshaded regions are FALSE](images/control-structures/TrueFalse.png){width="20%"}
