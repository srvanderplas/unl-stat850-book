...
Git is a version control system - the goal of git and other version control systems is to help groups of programmers work on large projects together. Git manages a collection of files in a structured way - rather like "track changes" in Microsoft Word or version history in Dropbox, but much more powerful.
