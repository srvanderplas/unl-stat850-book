...
```{r proc-means-demo-setup, include = F, engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, collectcode = T, warning = T, error = T}
ODS HTML style= HTMLBlue; 
```
```{r proc-means-demo, fig.path = "image/", engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, collectcode = T, warning = T, error = T}
libname classdat "sas/";
...
```{r proc-univariate-demo-setup, include = F, engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, collectcode = T, warning = T, error = T}
ODS HTML style= HTMLBlue; 
```
```{sashtml proc-univariate-demo, fig.path = "image/", engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, collectcode = T, warning = T, error = T}
libname classdat "sas/";
...
```{r proc-corr-demo, fig.path = "image/", engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, collectcode = F, warning = T, error = T}
libname classdat "sas/";
