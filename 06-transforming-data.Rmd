...
```{sashtml sas-college-read-data-setup, include = F, collectcode=T}
...
```{sashtml sas-college-split-string-words-setup, collectcode=T,include = F, fig.path = "image/"}
ODS HTML style=HTMLblue;
```
```{sashtml sas-college-split-string-words, fig.path = "image/", collectcode=T}
libname classdat "sas/";
DATA collegename;
SET classdat.college;
...
<details><summary>SAS solution</summary>
```{sashtml, fig.path = "image/", collectcode=T,include = F}
ODS HTML style=HTMLblue;
```
```{sashtml measles-bangladesh-sas, fig.path = "image/", collectcode=T}
libname classdat "sas/";
...
ODS HTML style=HTMLblue;
```
```{sashtml polio-sas, fig.path = "image/", collectcode=T}
libname classdat "sas/";
...
```{sashtml flights-delay-age-sas-plot1-setup, include = F, collectcode=T}
ODS HTML style=HTMLBLUE;
```
...
```{sashtml flights-delay-age-sas-plot2-setup, include = F, collectcode=T}
ODS HTML style=HTMLBLUE;
```
