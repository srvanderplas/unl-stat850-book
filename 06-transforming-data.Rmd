...
PROC TRANSPOSE DATA=classdat.who_disease OUT = classdat.disease_long;
BY Disease Cname NOTSORTED; /* specify notsorted unless you know your data are sorted */
...
To move a data frame from long format to wide format, we use PROC TRANSPOSE in SAS (again) or `pivot_wider` in R with `dplyr`. 
