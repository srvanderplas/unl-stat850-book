...
```{r sas-gchart, fig.path = "image/", engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, error = T}
...
```{r clear-all-sas-output8-1, include=F, engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, collectcode = F}
...
```{sashtml ods-pie, collectcode=T, fig.path = "image/", engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, error = T}
ODS HTML style= HTMLBlue; /* needed for color graphs in bookdown */
libname classdat "sas/";
...
```{r sas-data-setup-0, fig.path = "image/", engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, error = T}
libname classdat "sas/";
...
```{r basic-sgplot-scatterplot, error = T, fig.path = "image/", engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, error = T}
ODS HTML style= HTMLBlue; /* needed for color graphs in bookdown */
libname classdat "sas/";
...
<details><summary>SAS ODS Graphics</summary>
```{r sas-add-title-08, error = T, collectcode = T, fig.path = "image/", engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, error = T}
ODS HTML style= HTMLBlue; /* needed for color graphs in bookdown */
libname classdat "sas/";
...
<details><summary>SAS ODS Graphics</summary>
```{r sas-adj-aes-const-08, collectcode = T, fig.path = "image/", engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, error = T}
ODS HTML style= HTMLBlue; /* needed for color graphs in bookdown */
libname classdat "sas/";
...
```{r base-cat-aes-map-08-err, error = T, fig.show = 'none'}
...
```{r sas-cat-aes-map-08, collectcode = T, fig.path = "image/", engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, error = T}
ODS HTML style= HTMLBlue; /* needed for color graphs in bookdown */
libname classdat "sas/";
...
```{r sas-line-plot-color-08, collectcode = T, fig.path = "image/", engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, error = T}
ODS HTML style= HTMLBlue; /* needed for color graphs in bookdown */
libname classdat "sas/";
...
```{r sas-numeric-aes-bubble-08, collectcode = T, fig.path = "image/", engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, error = T}
ODS HTML style= HTMLBlue; /* needed for color graphs in bookdown */
libname classdat "sas/";
...
```{r sas-boxplot-08, collectcode = F, fig.path = "image/", engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, error = T}
ODS HTML style= HTMLBlue; /* needed for color graphs in bookdown */
libname classdat "sas/";
...
```{r sas-hist-08, collectcode = F, fig.path = "image/", engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, error = T}
ODS HTML style= HTMLBlue; /* needed for color graphs in bookdown */
libname classdat "sas/";
...
```{r sas-kernel-dens-08, collectcode =F, fig.path = "image/", engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, error = T}
ODS HTML style= HTMLBlue; /* needed for color graphs in bookdown */
libname classdat "sas/";
...
```{r sas-hist-dens-08, collectcode = F, fig.path = "image/", engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, error = T}
ODS HTML style= HTMLBlue; /* needed for color graphs in bookdown */
libname classdat "sas/";
...
```{r sas-bar-08, collectcode = F, fig.path = "image/", engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, error = T}
...
```{r sas-facet-08, collectcode = F, fig.path = "image/", engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, error = T}
ODS HTML style= HTMLBlue; /* needed for color graphs in bookdown */
libname classdat "sas/";
