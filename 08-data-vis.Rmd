...
Unfortunately, in this map there is not an underlying polygon (the coastline is a series of shorter segments), so I have provided a theme statement that should provide a white background upon which you can build. 
```{r}
library(ggplot2)
library(ggthemes)
library(tidyverse)
