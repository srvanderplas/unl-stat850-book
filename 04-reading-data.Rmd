...
```{r sas-file-download, engine = "sashtmllog", engine.path = sasexe, engine.opts = sasopts, collectcode = F, error = T}
...
```{r csv-import-sas, engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, collectcode = F, eval = T}
...
```{r pokemon-sas, engine = "sashtmllog", engine.path = sasexe, engine.opts = sasopts, collectcode = F, error = T}
...
```{r pipe-delimited-SAS-r2, engine = "sashtmllog", engine.path = sasexe, engine.opts = sasopts, collectcode = F, error = T}
...
```{r proc-import-data-step, engine = "sashtmllog", engine.path = sasexe, engine.opts = sasopts, collectcode = F, warning = T, error = T}
...
```
<details><summary>Solution</summary>
```{r rebrickable-tryitout-solution-sas, engine = "sashtmllog", engine.path = sasexe, engine.opts = sasopts, collectcode = F, warning = T, error = T}
libname classdat "sas/";
...
```{r proc-import-sas, engine = "sashtmllog", engine.path = sasexe, engine.opts = sasopts, collectcode = F, warning = T, error = T}
libname classdat "sas/";
...
```{r tryitout-dmv-solution-sas, engine = "sashtmllog", engine.path = sasexe, engine.opts = sasopts, collectcode = F, warning = T, error = T}
...
```{r nhts-sas-binary, engine = "sashtmllog", engine.path = sasexe, engine.opts = sasopts, collectcode = F, warning = T, error = T}
...
```{r sqlite3-sas, engine = "sashtmllog", engine.path = sasexe, engine.opts = sasopts, collectcode = F, warning = T, error = T}
...
```{r sas-proc-freq-demo-setup, include = F, engine = "sashtmllog", engine.path = sasexe, engine.opts = sasopts, collectcode = T, warning = T, error = T}
ODS HTML style= HTMLBlue; 
```
```{r proc-freq-demo, fig.path = "image/", engine = "sashtmllog", engine.path = sasexe, engine.opts = sasopts, collectcode = T, warning = T, error = T}
libname classdat "sas/";
...
```{r proc-means-demo-setup, include = F, engine = "sashtmllog", engine.path = sasexe, engine.opts = sasopts, collectcode = T, warning = T, error = T}
ODS HTML style= HTMLBlue; 
```
```{r proc-means-demo, fig.path = "image/", engine = "sashtmllog", engine.path = sasexe, engine.opts = sasopts, collectcode = T, warning = T, error = T}
libname classdat "sas/";
...
```{r proc-univariate-demo-setup, include = F, engine = "sashtmllog", engine.path = sasexe, engine.opts = sasopts, collectcode = T, warning = T, error = T}
ODS HTML style= HTMLBlue; 
```
```{sashtml proc-univariate-demo, fig.path = "image/", engine = "sashtmllog", engine.path = sasexe, engine.opts = sasopts, collectcode = T, warning = T, error = T}
libname classdat "sas/";
...
```{r proc-corr-demo, fig.path = "image/", engine = "sashtmllog", engine.path = sasexe, engine.opts = sasopts, collectcode = F, warning = T, error = T}
libname classdat "sas/";
...
<details><summary>Solution</summary>
```{r police-violence-tryitout-setup, include = F, engine = "sashtmllog", engine.path = sasexe, engine.opts = sasopts, collectcode = T, warning = T, error = T}
ODS HTML style= HTMLBlue; 
```
```{r police-violence-tryitout, fig.path = "image/", engine = "sashtmllog", engine.path = sasexe, engine.opts = sasopts, collectcode = T, warning = T, error = T}
libname classdat "sas/";
