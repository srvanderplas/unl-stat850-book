...
<details>
```{sashtml proc-means-demo}
libname classdat "/home/susan/Projects/Class/unl-stat850/2020-stat850/sas/";

PROC MEANS DATA = classdat.legoset;
run;
...
<details>
```{sashtml proc-univariate-demo}
libname classdat "/home/susan/Projects/Class/unl-stat850/2020-stat850/sas/";

ODS GRAPHICS ON;
PROC UNIVARIATE DATA = classdat.legoset;
VAR num_parts year;
HISTOGRAM num_parts year;
RUN;
ODS GRAPHICS OFF;
```
</details>
...
DATA classdat.police2;
SET classdat.police;
age = input(Victim_s_age, ?3.);
date = input(VAR6, MMDDYY10.);
run;

PROC FREQ DATA = classdat.police2 ORDER=FREQ;
TABLES Victim_s_gender Victim_s_race State Cause_of_death Unarmed Geography__via_Trulia_methodolog / MAXLEVELS = 10;
RUN;

PROC MEANS DATA = classdat.police2;
VAR age; /* Only numeric variable in this set */
RUN;

PROC UNIVARIATE DATA = classdat.police2;
HISTOGRAM age date;
