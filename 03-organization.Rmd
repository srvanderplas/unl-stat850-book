...
```{r function-demo, results = 'hold', collapse = T}
adder <- function(a, b) {
  return(a + b)
}
...
```{r iml-function-demo, engine = "sashtmllog", engine.path = sasexe, engine.opts = sasopts, collectcode = F}
proc IML;
  ...
  /* In IML, you can use the function like this as well */
  c = adder(3, 4); 
  print '3 + 4 = ' c;
