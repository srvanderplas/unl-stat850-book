...
myfun(5, 6) # a is 5 inside the function, so that overrides the a defined outside the function
...
myfun3(5, 3) # now, a is defined inside fun3 as a = 5, so there is an a in fun3's scope that isn't in the global environment.
