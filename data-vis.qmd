...
Obviously, there's a lot of ways to generate 3D-like charts in R, but can we actually generate 3D charts? Of course!
...
- [patchwork](https://github.com/ponnhide/patchworklib) (works with matplotlib, plotnine, and seaborn)
