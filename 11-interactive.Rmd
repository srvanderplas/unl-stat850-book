...
Let's see if volcano type makes a difference?
...
If we want to specify additional information that should show up in the tooltip, we can do that
So there isn't nearly as much variation as I was expecting in the elevation of different types of volcanoes. 

You may notice that ggplot2 complains about the unknown aesthetic I've added to geom_rug: That allows us to mouse over each data point in the rug plot and see what volcano it belongs to. So we can tell from the rug plot that the tallest volcano is Ojas de Salvado, in Chile/Argentina (I believe that translates to Eyes of Salvation?).
