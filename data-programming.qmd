# Programming with Data {#data-programming}
...
### Visual Summary of Data: Python (pandas) {-}
```{python summary-data-pandas}
# Base pandas
artwork.describe()
```

### Visual Summary of Data: Python (skimpy) {-}
...
### Defining a new variable: Python {-}
...
### Custom Summary Function: Python {-}
