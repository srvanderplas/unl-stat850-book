...
```{r sas-rand-density-09, collectcode = F, fig.path = "image/", engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, error = T}
...
<details><summary>In SAS</summary>
```{r sas-linear-reg-09, collectcode = F, fig.path = "image/", engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, error = T}
DATA tmp;
...
```{r sas-dog-simulation-09, collectcode = F, fig.path = "image/", engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, error = T}
DATA dogtemp;
  call streaminit(20572983);
  DO i = 1 to 1000;
...
```{r sas-var-converge-e-09, collectcode = F, fig.path = "image/", engine = "sashtml", engine.path = sasexe, engine.opts = sasopts, error = T}
DATA tmp;
