...
The `plot_ly` function is pipe friendly. Variable mappings are preceded with `~` to indicate that the visual appearance changes with the value of the variable. 
