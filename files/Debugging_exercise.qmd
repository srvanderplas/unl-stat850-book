...
Then, using what you know about R and SAS, try to debug the problem using the strategies in [Module 8](https://srvanderplas.github.io/unl-stat850/debugging.html). Once you are thoroughly stumped, or you believe you have solved the problem, compare your solutions to those given on StackOverflow using the link.
...
````
`r paste(readLines("https://raw.githubusercontent.com/srvanderplas/unl-stat850/main/other/debugging_3.txt"), collapse = '\n')`
````

You can find this sample file [here](https://raw.githubusercontent.com/srvanderplas/unl-stat850/main/other/debugging_3.txt)
